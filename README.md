...
Currently working @ **[Stack Overflow](https://stackoverflow.com/)**, where AI learns all the marvellous code that powers my frustration when I go on a vibe-coding spree. I'm tasked with improving customer-facing technical operations and just do things that I believe are cool :D (it seems to work).
